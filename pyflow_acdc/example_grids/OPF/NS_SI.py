...
def NS_SI():    
    ...
    lines_AC_data = [
        {'fromNode': 'GB1', 'toNode': 'GB2', 'r': 0.00017313019390581717, 'x': 0.0023202967902032647, 'g': 0.0, 'b': 0.30621103594539706, 'MVA_rating': 4679.654871889592, 'kV_base': 380, 'm': 1, 'shift': 0, 'Line_id': 'GBL1'},
        ...
        {'fromNode': 'GB6', 'toNode': 'GB7', 'r': 0.0002631578947368421, 'x': 0.003526851121108963, 'g': 0.0, 'b': 0.46544077463700356, 'MVA_rating': 4679.654871889592, 'kV_base': 380, 'm': 1, 'shift': 0, 'Line_id': 'GBL7'},
        {'fromNode': 'GB7', 'toNode': 'GB8', 'r': 0.00035422437673130196, 'x': 0.0012814391087010999, 'g': 0.0, 'b': 7.875294198536438, 'MVA_rating': 2632.7172275046933, 'kV_base': 380, 'm': 1, 'shift': 0, 'Line_id': 'GBL8'},
        {'fromNode': 'GB8', 'toNode': 'GB9', 'r': 0.0004951523545706371, 'x': 0.001791258969152075, 'g': 0.0, 'b': 6.192267615784699, 'MVA_rating': 1974.53792062852, 'kV_base': 380, 'm': 1, 'shift': 0, 'Line_id': 'GBL9'},
        ...
        {'fromNode': 'BE3', 'toNode': 'BE5', 'r': 0.0002839335180055402, 'x': 0.0038052867359333544, 'g': 0.0, 'b': 0.5021860989504512, 'MVA_rating': 4679.654871889592, 'kV_base': 380, 'm': 1, 'shift': 0, 'Line_id': 'BEL3'},
        ...
        {'fromNode': 'BE8', 'toNode': 'NL6', 'r': 0.00047783933518005545, 'x': 0.0064040191409610115, 'g': 0.0, 'b': 0.845142459209296, 'MVA_rating': 4679.654871889592, 'kV_base': 380, 'm': 1, 'shift': 0, 'Line_id': 'ICL1'},
        ...
        {'fromNode': 'NL11', 'toNode': 'NL12', 'r': 0.00017313019390581717, 'x': 0.0023202967902032647, 'g': 0.0, 'b': 0.30621103594539706, 'MVA_rating': 4679.654871889592, 'kV_base': 380, 'm': 1, 'shift': 0, 'Line_id': 'NLL13'},
        {'fromNode': 'NL11', 'toNode': 'DE1', 'r': 0.0002077562326869806, 'x': 0.002784356148243918, 'g': 0.0, 'b': 0.36745324313447647, 'MVA_rating': 4679.654871889592, 'kV_base': 380, 'm': 1, 'shift': 0, 'Line_id': 'ICL2'},
        ...
        {'fromNode': 'DE8', 'toNode': 'DK2', 'r': 0.0011357340720221608, 'x': 0.015221146943733417, 'g': 0.0, 'b': 2.0087443958018047, 'MVA_rating': 4679.654871889592, 'kV_base': 380, 'm': 1, 'shift': 0, 'Line_id': 'ICL3'},
        {'fromNode': 'DE9', 'toNode': 'DK1', 'r': 0.0003289473684210527, 'x': 0.004408563901386203, 'g': 0.0, 'b': 2.3272038731850175, 'MVA_rating': 9359.309743779184, 'kV_base': 380, 'm': 1, 'shift': 0, 'Line_id': 'ICL4'},
    ...
    lines_DC_data = [
        {'fromNode': 'DES1', 'toNode': 'DES2', 'r': 0.00017008463541666666, 'MW_rating': 4699.999998720001, 'kV_base': 320, 'Length_km': 110, 'Mono_Bi_polar': 'b', 'Line_id': 'Germany_south'},
        {'fromNode': 'DEN1', 'toNode': 'DEN2', 'r': 0.0004020182291666666, 'MW_rating': 2199.9999993600004, 'kV_base': 320, 'Length_km': 130, 'Mono_Bi_polar': 'b', 'Line_id': 'Germany_north'},
    ...
    Converters_ACDC_data = [
        {'AC_type': 'Slack', 'DC_type': 'PAC', 'AC_node': 'OFW_DEn', 'DC_node': 'DEN1', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': 0.0, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.0008326446280991736, 'PR_x': 0.010709974955419749, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 1200.0, 'Nconverter': 2, 'pol': 1, 'Conv_id': 'Conv_DEN1', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'PV', 'DC_type': 'Slack', 'AC_node': 'DE8', 'DC_node': 'DEN2', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': 0.0, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.0008326446280991736, 'PR_x': 0.010709974955419749, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 1200.0, 'Nconverter': 2, 'pol': 1, 'Conv_id': 'Conv_DEN2', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'Slack', 'DC_type': 'PAC', 'AC_node': 'OFW_DEs', 'DC_node': 'DES1', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': 0.0, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.0008326446280991736, 'PR_x': 0.010709974955419749, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 1200.0, 'Nconverter': 4, 'pol': 1, 'Conv_id': 'Conv_DES1', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'PV', 'DC_type': 'Slack', 'AC_node': 'DE1', 'DC_node': 'DES2', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': 0.0, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.0008326446280991736, 'PR_x': 0.010709974955419749, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 1200.0, 'Nconverter': 4, 'pol': 1, 'Conv_id': 'Conv_DES2', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'PV', 'DC_type': 'Slack', 'AC_node': 'BE2', 'DC_node': 'MTDC1', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': -0.85, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.00125, 'PR_x': 0.015902690085320234, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 800.0, 'Nconverter': 2, 'pol': 1, 'Conv_id': 'Conv_MTDC1', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'PV', 'DC_type': 'P', 'AC_node': 'BE1', 'DC_node': 'MTDC2', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': -0.99, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.00125, 'PR_x': 0.015902690085320234, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 800.0, 'Nconverter': 2, 'pol': 1, 'Conv_id': 'Conv_MTDC2', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'Slack', 'DC_type': 'PAC', 'AC_node': 'OFW_NL', 'DC_node': 'MTDC4', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': 19.87, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.0008326446280991736, 'PR_x': 0.010709974955419749, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 1000.0, 'Nconverter': 2, 'pol': 1, 'Conv_id': 'Conv_MTDC4', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'PV', 'DC_type': 'Slack', 'AC_node': 'NL9', 'DC_node': 'MTDC5', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': 0.0, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.0008326446280991736, 'PR_x': 0.010709974955419749, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 1000.0, 'Nconverter': 4, 'pol': 1, 'Conv_id': 'Conv_MTDC5', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'Slack', 'DC_type': 'PAC', 'AC_node': 'OFW_DEC', 'DC_node': 'MTDC6', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': 19.87, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.0008326446280991736, 'PR_x': 0.010709974955419749, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 1000.0, 'Nconverter': 4, 'pol': 1, 'Conv_id': 'Conv_MTDC6', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'PV', 'DC_type': 'Slack', 'AC_node': 'DE2', 'DC_node': 'MTDC7', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': 0.0, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.0008326446280991736, 'PR_x': 0.010709974955419749, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 1000.0, 'Nconverter': 4, 'pol': 1, 'Conv_id': 'Conv_MTDC7', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'Slack', 'DC_type': 'PAC', 'AC_node': 'OFW_DK', 'DC_node': 'MTDC8', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': 29.63, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.00125, 'PR_x': 0.015902690085320234, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 800.0, 'Nconverter': 4, 'pol': 1, 'Conv_id': 'Conv_MTDC8', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2},
        {'AC_type': 'PV', 'DC_type': 'Slack', 'AC_node': 'DK6', 'DC_node': 'MTDC9', 'P_AC': 0.0, 'Q_AC': 0, 'P_DC': 0.0, 'T_r': 0.0, 'T_x': 0.0, 'PR_r': 0.0008326446280991736, 'PR_x': 0.010709974955419749, 'Filter_b': 0.0, 'Droop': 0, 'AC_kV_base': 220, 'MVA_rating': 1000.0, 'Nconverter': 4, 'pol': 1, 'Conv_id': 'Conv_MTDC9', 'lossa': 1.103, 'lossb': 0.887, 'losscrect': 2.885, 'losscinv': 4.371, 'Ucmin': 0.85, 'Ucmax': 1.2}
    ]
